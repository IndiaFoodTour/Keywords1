...
keywords = ['Food Tours', 'India Food Tour', 'Food Tour India', 'Food Tours India', 'Food Tour in India', 'Food Tours in India', 'Food Walk India']
...
def number_of_search_results(key):
    ...
    google_main_url = 'https://www.google.com/search?q=' + key
    google_news_url = 'https://www.google.com/search?hl=en&gl=in&tbm=nws&authuser=0&q=' + key
